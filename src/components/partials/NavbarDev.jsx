...
import { MdLogout, MdMenu, MdAccountCircle, MdOutlineFeedback } from 'react-icons/md';
    ...
    <nav className="fixed top-0 w-full lg:px-16 px-6 flex flex-wrap items-center lg:py-0 py-2 bg-amber-950 shadow-md z-50">
      <div className='w-full container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 md:h-14 h-12'>
        ...
        <div className='flex-1 flex justify-between items-center'>
          {/* Logo Section */}
          <Link to="/devLayout" className='flex items-center gap-1 sm:gap-2'>
      ...
      >
        <ul className="flex flex-col pt-3 pb-3 gap-3 text-lg font-semibold px-4">
          <li><Link to="/devLayout/profile" onClick={() => setIsMobileMenuOpen(false)} className='flex items-center gap-3 text-amber-950 hover:text-amber-700 text-base transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem"><MdAccountCircle size={18} />Profile</Link></li>
          <li><Link to="/devLayout/accountmanagement" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 text-amber-950 hover:text-amber-700 text-base transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem"><MdAccountCircle size={18} />Account Management</Link></li>
          <li><Link to="/devLayout/feedbackdetails" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 text-amber-950 hover:text-amber-700 text-base transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem"><FaListAlt size={18} />Feedback Details</Link></li>
          <li><Link to="/devLayout/feedback" onClick={() => setIsMobileMenuOpen(false)} className='flex items-center gap-3 text-amber-950 hover:text-amber-700 text-base transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem"><MdOutlineFeedback size={18} />Feedback</Link></li>
          <li><button onClick={confirmLogout} className='flex items-center gap-3 text-amber-950 hover:text-amber-700 text-base transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem"><MdLogout size={18} />Log out</button></li>
          </ul>
      </div>
