    ...
    <nav className="fixed top-0 w-full lg:px-16 px-6 flex flex-wrap items-center lg:py-0 py-2 bg-amber-950 shadow-md z-50">
      <div className='w-full container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 md:h-14 h-12'>
        ...
        <div className='flex-1 flex justify-between items-center'>
          {/* Logo Section */}
          <Link to="/Pre_VPLayout" className='flex items-center gap-1 sm:gap-2'>
      ...
      >
        <ul className="flex flex-col pt-3 pb-3 gap-3 text-lg font-semibold px-4">
          <li><Link to="/Pre_VPLayout/profile" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Profile</Link></li>
          <li><Link to="/Pre_VPLayout" onClick={() => setIsMobileMenuOpen(false)} className="text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem">Announcements</Link></li>
          <li><Link to="/Pre_VPLayout/requests" onClick={() => setIsMobileMenuOpen(false)} className="text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem">Request and Complaints</Link></li>
          <li><Link to="/Pre_VPLayout/emergencyLogs" onClick={() => setIsMobileMenuOpen(false)} className="text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem">Emergency Logs</Link></li>
          <li><Link to="/Pre_VPLayout/visitorLogs" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Visitor Logs</Link></li>
          <li><Link to="/Pre_VPLayout/officials" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Officials Board</Link></li>
          <li><Link to="/Pre_VPLayout/feedback" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Feedback Logs</Link></li>
